...
// NOTA: el toggle del botón hamburguesa (.menu-toggle) lo maneja
// initSidebarMovil() en app.js. Acá había un segundo listener que hacía
// exactamente lo mismo sobre el mismo botón (el <button> tiene tanto la
// clase .menu-toggle como el atributo data-toggle-sidebar) — al dispararse
// los dos en cada click, un toggle() abría y el otro cerraba en el mismo
// instante, y el menú parecía no responder. Se saca de acá para que quede
// un solo manejador (el de app.js, que es el que venía andando bien).
